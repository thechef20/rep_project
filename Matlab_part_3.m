...
A = readtable("Part3.csv");
%save('ma/Users/benrudnick/Desktop/Fin_replication_projecttlab_part2.mat', 'A')
save('part3.mat','A')
%%
%loading data
clc;
...
clear; clc;
%A = readtable("matlab_part2_1991.csv");
A = readtable("matlab_part2_TEST.csv");
%save('ma/Users/benrudnick/Desktop/Fin_replication_projecttlab_part2.mat', 'A')
save('matlab_part3.mat','A')
%%
%loading data
clc;
...
real_output =[];
    ...
    if current_stock == next_stock
        ...
        individual = individual_stock_return(i-counter:i); 
