...
export delimited using "matlab_part2.csv", replace

** Cross Secitonal Regression 
drop if annual >1991
gen modate = ym(annual, mmonth) 
format %tm modate

xtset kypermno modate

asreg mretx  average_pre_rank_beta, fmb

*asreg mretx average_mcap_log, fmb
