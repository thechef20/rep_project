...
*we do not need a sort here b/c the fasterextile does not require
...
*Ben --> please change merged_portfolio_and_preranked_beta_data to end_of_step_3_stata for consistencey and update crosssectioal
